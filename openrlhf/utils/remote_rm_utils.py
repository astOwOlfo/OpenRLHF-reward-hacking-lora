...
def remote_rm_fn(api_url, queries, test_cases, score_key="rewards"):
    ...
    """
    scores = request_api_wrapper(api_url, {"query": queries, "test_cases": test_cases}, score_key)
    return torch.tensor(scores)


@ray.remote
def remote_rm_fn_ray(api_url, queries, test_cases, score_key="rewards"):
